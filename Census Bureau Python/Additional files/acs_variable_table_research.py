...
if __name__ == "__main__":
    ...
    # --- Step 7: Save outputs ---
    output_file_vars = os.path.join(os.getcwd(), "acs5_2022_variables_filtered.csv")
    variables_df.to_csv(output_file_vars, index=False)
    print(f"\nFull variable list saved to: {output_file_vars}")
